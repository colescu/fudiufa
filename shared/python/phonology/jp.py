...
class JPSyllable(Syllable):
    ...
    def ipa_strict_no_tone(self) -> str:
        ...
        syllable = JPSyllable.historical_to_modern(self)
    ...
    def pinyin(self, format: str = "kata", **kwargs):
    ...
    @classmethod
    def historical_to_modern(cls, syllable: "JPSyllable") -> "JPSyllable":
        """
