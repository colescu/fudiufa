...
- [爺]<sub>父親</sub> {ia2} <sub>白</sub> --- <em>[爺]</em>爺 {ie2} <sub>文</sub>
- [些] {xie1}（無白讀）
...
- 上聲讀作陰平：[侮] {u3} [頗] {po3} [稍:sau3] {sau3} [剖] {peu3}
- 陰去讀作陰平：[播] {bo5} [糙] {cau5} [勘] {kon5} [綜:zung5] {zung5}
