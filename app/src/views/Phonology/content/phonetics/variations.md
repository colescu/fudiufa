...
本站取較新派的讀法，即將 :x(i=i) 、:x(ui=wi) 均念作 :x(i=i) 。

<!-- 不過撫州話本來也只在零聲母或牙音 :x(g=k) 、:x(k=kʰ) 後區分開合口（即是否有介音 :x(u=w)），所以脣音後讀 :x(i=i) 還是 :x(ui=wi) 沒有本質區別。其他來源的 :x(i=i) 也可有類似的變讀，例如「[飛]」{fi1}D 亦可讀作 {fui1}D 。甚至其他韻母也是，例如「[雷][累:lui6]」白讀 {loi}D 亦可讀作 {luoi}D ，見於《臨川音系》。<Tooltip>《臨川音系》說「[堆][崔]」等舌齒音聲母字也可讀作 (:x(u=w)):x(oi=oɪ) ，且該讀法爲城內音。然而實際上市區現在這樣讀的很少，它更像是老的層次，聽上去更「土」。</Tooltip> -->
